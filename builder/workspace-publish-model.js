  ...
  const kind = scene?.mapType === 'building' ? 'building'
    : scene?.mapType === 'town' ? 'town'
      : scene?.mapType === 'level' ? 'level'
        : scene?._workspaceKind === 'building' ? 'building'
